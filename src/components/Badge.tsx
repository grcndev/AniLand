...
const Badge = ({ title, age, episodes, format, rating, status }) => {
  return (
    <div className="flex flex-col bg-sgtxcol ml-52 p-16 rounded -mt-72 w-64 relative z-10">
      <div className="flex items-center -mt-8 justify-between gap-1">
        <h4 className="flex text-left -ml-10 w-24 text-txtfilter text-sm ">
          {title}
        </h4>
        <svg
      ...
      <div className="">
        ...
        <span className="flex -ml-10 text-sm mb-4 text-txtcard">
