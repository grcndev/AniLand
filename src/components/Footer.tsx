    ...
    <div className="grid mt-10 font-bold bg-footerbg ">
      <div className="grid sm:grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 2xl:mt-10 ml-48">
        ...
        <div className=" xl:ml-80 mb-6">
          <h2 className="cursor-pointer text-footertxt hover:text-addlist sm:mt-6 md:mt-8 lg:mt-6 xl:mt-6 mt-4 mb-2">
            Donate
          </h2>
          <h2 className="cursor-pointer text-footertxt hover:text-addlist mb-2">
            AniLand.co
          </h2>
          <h2 className="cursor-pointer text-footertxt hover:text-addlist mb-8">
            AniChart.net
          </h2>
        </div>
        <div className="xl:ml-52 mb-6">
          <h2 className="cursor-pointer text-footertxt hover:text-addlist lg:mt-6 xl:mt-6  2xl:mt-4 mb-2">
            Apps
          </h2>
          <h2 className="cursor-pointer text-footertxt hover:text-addlist mb-2">
            Site Stats
        ...
        <div className="xl:ml-36 mb-6">
          <h2 className="cursor-pointer text-footertxt hover:text-addlist xl:mt-6 mb-2">
            Discord
          </h2>
          <h2 className="cursor-pointer text-footertxt hover:text-addlist mb-2">
            Twitter
        ...
        <div className="mb-6">
          <h2 className="cursor-pointer text-footertxt hover:text-addlist 2xl:mt-4 mb-2">
            App Data
          </h2>
          <h2 className="cursor-pointer text-footertxt hover:text-addlist mb-2">
            Moderators
